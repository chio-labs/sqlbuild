...
- `public/index.html` and `public/styles.css`: the homepage, plain static HTML and CSS. Its terminal examples are real `sqb` output from the projects in `examples/`, trimmed to the relevant lines.

...
- [Sources: Source freshness](/docs/concepts/sources#source-freshness) for freshness configuration
- [Planning and Change Detection](/docs/concepts/planning) for how freshness feeds into change-aware builds

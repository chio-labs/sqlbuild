...
Run end-to-end scenario tests. Scenarios materialize fixture inputs as physical relations, build the real project graph against them, and evaluate expected outputs and assertions. See [Scenarios](/docs/concepts/scenarios) for concepts and authoring details.
...
See [parallel CI runs](/docs/concepts/scenarios#parallel-ci-runs) for namespace configuration and cleanup.

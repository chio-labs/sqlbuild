...
[Project Configuration](/docs/concepts/project-configuration#sqlbuild_localtoml).
...
See [Incremental](/docs/concepts/incremental) for details on cursor-based strategies and microbatch processing.
...
- [Models](/docs/concepts/models) - understand `MODEL()` headers and materialization types
- [Rules](/docs/concepts/rules) - add compile-time SQL, architecture, and model-shape checks
- [Functions](/docs/concepts/functions) - SQL UDFs, Python UDFs, and table functions
- [Incremental](/docs/concepts/incremental) - learn about cursor-based incremental strategies
- [Audits](/docs/concepts/audits) - configure data quality checks
- [Testing](/docs/concepts/testing) - write SQL unit tests and multi-model tests with macro support
- [Column Lineage](/docs/concepts/column-lineage) - trace individual columns through your pipeline
- [CLI Reference](/docs/cli/build) - full command reference

...
<CardGroup cols={2}>
  <Card title="RuleContext and compiler facts" icon="diagram-project" href="/docs/concepts/rules/custom-rules/rule-context">
    Inspect SQL, graph, contracts, tests, audits, declarations, and project structure.
  </Card>
  <Card title="Testing and deterministic Rules" icon="flask" href="/docs/concepts/rules/custom-rules/testing-and-determinism">

...
other authored resource. The [Scope Explorer](/docs/concepts/declaration-scopes/explorer) shows the owner
...
<CardGroup cols={2}>
  <Card title="How Visibility Works" icon="eye" href="/docs/concepts/declaration-scopes/visibility">
    See which declarations a model, test, hook, or function can use.
  </Card>
  <Card title="Where to Put Declarations" icon="location-dot" href="/docs/concepts/declaration-scopes/placement">
    Choose the narrowest folder that contains every real use.
  </Card>
  <Card title="Scope Explorer" icon="compass" href="/docs/concepts/declaration-scopes/explorer">
    Ask SQLBuild what a file can use and preview how moving it would change that answer.
  </Card>
</CardGroup>

Learn the features themselves in [Enums](/docs/concepts/enums), [Constants](/docs/concepts/constants), and
[Writing Macros](/docs/concepts/macros). See [Interpolation](/docs/concepts/interpolation) for project,

...
| [BigQuery](/docs/concepts/adapters/bigquery) | Beta | `sqlbuild[bigquery]` |
| [Databricks](/docs/concepts/adapters/databricks) | Beta | `sqlbuild[databricks]` |
| [SQL Server](/docs/concepts/adapters/sqlserver) | Beta | `sqlbuild[sqlserver]` |
| ClickHouse | Planned | |
| Redshift | Planned | |
| Trino | Planned | |
| Spark | Planned | |

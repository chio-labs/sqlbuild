...
Clone is a physical-layer operation. VDE pointer management is handled by [build](/docs/concepts/virtual-environments/building) and [promote](/docs/concepts/virtual-environments/promotion).

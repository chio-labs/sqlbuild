...
Sources have related behavior but different configuration. A source can explicitly set `type_enforcement: false`; see [Sources](/docs/concepts/sources#type-enforcement).

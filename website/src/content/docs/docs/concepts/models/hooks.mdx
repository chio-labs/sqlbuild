...
|-------|------------|-----|
| [`inline_sql("...")`](/docs/concepts/models/hooks/sql#inline-sql-hooks) | SQL written directly in the model header | Short, model-specific SQL |
| [`sql("name", args...)`](/docs/concepts/models/hooks/sql) | A reusable resource under `hooks/sql/` | Shared, parameterized SQL |
| [`python("name", args...)`](/docs/concepts/models/hooks/python) | A decorated function under `hooks/python/` | Control flow, providers, queries, or skips |
...
- [SQL hooks](/docs/concepts/models/hooks/sql)
- [Python hooks](/docs/concepts/models/hooks/python)

...
[Virtual environments](/docs/concepts/virtual-environments) additionally bind each model to a versioned
...
[Building in a virtual environment](/docs/concepts/virtual-environments/building#stale-driven-execution).
...
[Source freshness](/docs/concepts/planning/source-freshness) records an observable data version for a
...
See [Cascade propagation](/docs/concepts/planning/cascade-propagation) for the detailed materialization
rules.
...
See [Selection and staleness](/docs/concepts/planning/selection-and-staleness) for closure selectors and
...
see [Virtual environment setup](/docs/concepts/virtual-environments/setup).

## Related topics

- [Cascade propagation](/docs/concepts/planning/cascade-propagation)
- [Source freshness](/docs/concepts/planning/source-freshness)
- [Selection and staleness](/docs/concepts/planning/selection-and-staleness)
- [Building in a virtual environment](/docs/concepts/virtual-environments/building)

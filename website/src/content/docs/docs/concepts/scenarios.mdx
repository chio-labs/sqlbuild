...
[How Visibility Works](/docs/concepts/declaration-scopes/visibility#tests-and-expected-output).
...
See the [CLI reference](/docs/cli/scenario) for full command documentation.

...
[Composition and Context](/docs/concepts/macros/composition-and-context) for complete examples.
...
<Card title="Next: Where to Put Declarations" icon="arrow-right" href="/docs/concepts/declaration-scopes/placement">

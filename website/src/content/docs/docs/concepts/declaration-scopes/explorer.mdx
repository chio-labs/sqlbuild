...
Use this page for common workflows. See the [`sqb scope` CLI reference](/docs/cli/scope) for every flag,
...
<CardGroup cols={2}>
  ...
  <Card title="CLI Reference" icon="terminal" href="/docs/cli/scope">

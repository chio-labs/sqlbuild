...
- [Setup](/docs/concepts/virtual-environments/setup) - configuration and state initialization
- [Building](/docs/concepts/virtual-environments/building) - virtual builds, partial builds, seeded incrementals
- [Promotion](/docs/concepts/virtual-environments/promotion) - promoting VDEs
- [Rollback](/docs/concepts/virtual-environments/rollback) - checkpoints and rollback
- [Clone](/docs/concepts/virtual-environments/clone) - hydrating physical versions from a source warehouse
- [Diff](/docs/concepts/virtual-environments/diff) - comparing VDE ref sets
- [Adopt and Detach](/docs/concepts/virtual-environments/adopt-detach) - migrating existing projects
- [Reconcile](/docs/concepts/virtual-environments/reconcile) - diagnosing and repairing drift
- [Locks](/docs/concepts/virtual-environments/locks) - concurrent access control
- [Janitor](/docs/concepts/virtual-environments/janitor) - cleanup and retention
- [Recovery](/docs/concepts/virtual-environments/recovery) - what to do when things break

...
| Canonical presentation | [`sqb format`](/docs/cli/format) (separate from the compiler) | Capitalization, indentation, spacing, comma and clause layout |
...
<Card title="Author custom Rules" icon="code" href="/docs/concepts/rules/custom-rules/overview">
...
See [Findings and exceptions](/docs/concepts/rules/findings-and-exceptions) for configuration examples.
...
See [Benchmarks](/docs/benchmarks#rules-performance) for the benchmark profiles and reproduction commands,
and [Execution and caching](/docs/concepts/rules/execution-and-caching) for the Rules lifecycle.

## Continue

<CardGroup cols={2}>
  <Card title="Configuration and selection" icon="sliders" href="/docs/concepts/rules/configuration-and-selection">
    Select exact Rules or families and configure project-owned options.
  </Card>
  <Card title="Findings and exceptions" icon="triangle-exclamation" href="/docs/concepts/rules/findings-and-exceptions">
    Understand diagnostics, exact exceptions, path ignores, and stale checks.
  </Card>
  <Card title="Execution and caching" icon="gauge-high" href="/docs/concepts/rules/execution-and-caching">
    Learn evaluation order, focused execution, and dependency-aware reuse.
  </Card>
  <Card title="Rules CLI" icon="terminal" href="/docs/cli/rules">

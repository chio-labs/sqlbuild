...
See [SQL Hooks](/docs/concepts/models/hooks/sql) for hook lifecycle and context syntax.
...
<CardGroup cols={2}>
  <Card title="Composition and Context" icon="code-branch" href="/docs/concepts/macros/composition-and-context">
    Compose macros through Python imports and use adapter or target context.
  </Card>
  <Card title="Declarations and Scopes" icon="folder-tree" href="/docs/concepts/declaration-scopes">

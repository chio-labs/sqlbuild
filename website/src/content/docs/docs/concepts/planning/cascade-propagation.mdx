...
- Source freshness changes propagate downstream the same way. See [Source freshness](/docs/concepts/planning/source-freshness).
...
See [Incremental Models: Replay on change](/docs/concepts/incremental#replay-on-change) for configuration details.

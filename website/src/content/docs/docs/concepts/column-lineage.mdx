...
See the [lineage CLI reference](/docs/cli/lineage) for full flag documentation and output format examples.
...
See the [compile CLI reference](/docs/cli/compile) for details on the compile report format.

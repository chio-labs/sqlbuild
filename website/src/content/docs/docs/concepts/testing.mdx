...
For end-to-end testing across many models with physical warehouse relations, see [Scenarios](/docs/concepts/scenarios).
...
tests. See [How Visibility Works](/docs/concepts/declaration-scopes/visibility#tests-and-expected-output).
...
project file; see [Rule options](/docs/concepts/rules/configuration-and-selection#rule-options).

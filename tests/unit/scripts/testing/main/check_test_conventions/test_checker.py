...
from scripts.testing.main.check_test_conventions import check_test_conventions
from tests.unit.scripts.testing.main.check_test_conventions._test_types import (
    CheckCliMainTestCase,
    CheckPathsTestCase,
)
from tests.unit.scripts.testing.main.check_test_conventions.helpers import (
    base_repo_files,
...
def test_given_repo_slice_when_running_cli_main_then_returns_expected_exit_code(
    ...
    exit_code: int = check_test_conventions([str(tmp_path / "tests")])

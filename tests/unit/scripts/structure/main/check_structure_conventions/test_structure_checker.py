...
from scripts.structure.main.check_structure_conventions import check_structure_conventions
from tests.unit.scripts.structure.main.check_structure_conventions._test_types import (
    CheckCliMainTestCase,
    CheckPathsTestCase,
)
from tests.unit.scripts.structure.main.check_structure_conventions.helpers import (
...
def test_given_repo_slice_when_running_cli_main_then_returns_expected_exit_code(
    ...
    exit_code: int = check_structure_conventions(
        [str(tmp_path / path) for path in test_case.cli_paths]
    )

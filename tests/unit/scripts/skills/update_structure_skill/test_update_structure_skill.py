...
from scripts.skills.update_structure_skill import build_skill_markdown, generated_marker
from tests.unit.scripts.skills.update_structure_skill._test_types import (
    StructureSkillGenerationTestCase,
)
from tests.unit.scripts.skills.update_structure_skill.helpers import write_structure_rules_file
...
@pytest.mark.parametrize(
    ...
    [
        StructureSkillGenerationTestCase(
            ...
            source_relative_path=Path("scripts/structure/structure_conventions/rules.py"),
            source_contents="""
...
""",
            expected_fragments=(
                ...
                "`SC063`, `SC064`, and `SC065` cap main/ public function statements",
                (

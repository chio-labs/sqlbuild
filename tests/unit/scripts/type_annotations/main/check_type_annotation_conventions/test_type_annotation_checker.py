...
from scripts.type_annotations.main.check_type_annotation_conventions import (
    check_type_annotation_conventions,
)
from tests.unit.scripts.type_annotations.main.check_type_annotation_conventions._test_helpers import (
    collect_violation_codes,
    compliant_repo_files,
)
from tests.unit.scripts.type_annotations.main.check_type_annotation_conventions._test_types import (
...
def test_given_repo_slice_when_running_type_annotation_cli_then_it_returns_expected_exit_code(
    ...
    assert (
        check_type_annotation_conventions(list(test_case.cli_paths)) == test_case.expected_exit_code
    )

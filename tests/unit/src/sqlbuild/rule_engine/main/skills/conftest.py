...
from sqlbuild.rule_engine._helpers.guidance import skill_installation
from sqlbuild.rule_engine.main import skills as skills_module
    ...
    try:
        with patch.object(skill_installation, "_stage_skills", side_effect=wait_and_stage):
            _ = skills_module.install_skills(
                config=RulesConfig(select=(selected_rule,)),

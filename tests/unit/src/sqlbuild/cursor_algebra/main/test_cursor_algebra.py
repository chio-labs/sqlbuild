...
@pytest.mark.parametrize(
    ...
    (
        ...
        TimestampTimezonePolicyTestCase(
            description="warehouse UTC suffix separator normalizes to ISO text",
            raw="2026-09-14 00:00:00.000 Z",
            directly_constructed_value=datetime(2026, 9, 14, tzinfo=UTC),
            expected_value=datetime(2026, 9, 14, tzinfo=UTC),
            expected_passthrough="2026-09-14 00:00:00.000Z",
            grain=CursorGrain.DAY,
            expected_exclusive_end="2026-09-15T00:00:00+00:00",
        ),
        TimestampTimezonePolicyTestCase(
            description="warehouse numeric offset separator normalizes to ISO text",
            raw="2026-09-14 08:30:00.000 +08:00",
            directly_constructed_value=datetime(
                2026,
                9,
                14,
            ...
            expected_value=datetime(2026, 9, 14, 0, 30, tzinfo=UTC),
            expected_passthrough="2026-09-14 08:30:00.000+08:00",
            grain=CursorGrain.HOUR,
            expected_exclusive_end="2026-09-14T01:00:00+00:00",
        ),
    ),

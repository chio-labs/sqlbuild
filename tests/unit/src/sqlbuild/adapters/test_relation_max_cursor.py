...
RELATION_MAX_CURSOR_TEST_CASES: tuple[AdapterRelationMaxCursorTestCase, ...] = (
    AdapterRelationMaxCursorTestCase(
...
SEED_SELECT_AFTER_CURSOR_TEST_CASES: tuple[AdapterSeedSelectAfterCursorTestCase, ...] = (
    AdapterSeedSelectAfterCursorTestCase(
...
@pytest.mark.parametrize(
    "test_case",
    RELATION_MAX_CURSOR_TEST_CASES,
    ids=[case.description for case in RELATION_MAX_CURSOR_TEST_CASES],
)
...
@pytest.mark.parametrize(
    "test_case",
    SEED_SELECT_AFTER_CURSOR_TEST_CASES,
    ids=[case.description for case in SEED_SELECT_AFTER_CURSOR_TEST_CASES],
)

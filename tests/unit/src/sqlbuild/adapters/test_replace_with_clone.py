...
_SUPPORTED_CASES: tuple[AdapterReplaceWithCloneTestCase, ...] = (
...
_UNSUPPORTED_CASES: tuple[AdapterReplaceWithCloneTestCase, ...] = (
    AdapterReplaceWithCloneTestCase(
...
@pytest.mark.parametrize("test_case", _SUPPORTED_CASES, ids=lambda case: case.description)
...
@pytest.mark.parametrize("test_case", _UNSUPPORTED_CASES, ids=lambda case: case.description)

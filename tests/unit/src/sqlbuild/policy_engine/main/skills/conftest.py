"""Process and failure orchestration for policy skill installation tests."""
...
from sqlbuild.policy_engine._helpers.guidance import skill_installation
from sqlbuild.policy_engine.main import skills as skills_module
    ...
    try:
        with patch.object(skill_installation, "_stage_skills", side_effect=wait_and_stage):
            _ = skills_module.install_skills(
                config=PolicyConfig(select=(selected_rule,)),

...
from sqlbuild.policy_engine.models import PolicyFault, PolicyResult
from tests.unit.src.sqlbuild.policy_engine.main.render_result._test_types import (
...
def test_given_policy_faults_when_rendering_json_and_text_then_both_contain_identical_facts(
    ...
    result: PolicyResult = test_case.result

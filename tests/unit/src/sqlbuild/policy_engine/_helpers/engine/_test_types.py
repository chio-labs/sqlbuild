"""Test case declarations for policy engine helpers."""

from dataclasses import dataclass

from sqlbuild.policy_engine.models import RuleExemption, RuleIgnore


@dataclass(frozen=True)
class PolicyConfigErrorTestCase:
    description: str
    source: str

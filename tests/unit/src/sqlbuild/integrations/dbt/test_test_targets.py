...
@pytest.mark.parametrize(
    ...
    [
        ...
        DbtSqlTestTargetTestCase(
            ...
            selected_dbt_unique_ids=("model.analytics.commerce__int_enriched__course_match_graph",),
            select=("commerce__int_enriched__course_match_graph",),
            expected_target_names=("commerce__int_enriched__course_match_graph",),
            expected_model_names=("commerce__int_enriched__course_match_graph",),
            expected_query_fragments=('__dbt_ref("stg_orders")',),
            manifest_factory=partial(
                build_dbt_sql_test_target_manifest,
                target_model_name="commerce__int_enriched__course_match_graph",
            ),
            mock_model_names=("stg_orders",),
        ),
        DbtSqlTestTargetTestCase(

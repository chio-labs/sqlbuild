...
TRANSLATION_TEST_CASES: tuple[DbtSourceFreshnessTranslationTestCase, ...] = (
    DbtSourceFreshnessTranslationTestCase(
...
INVALID_DURATION_TEST_CASES: tuple[DbtSourceFreshnessTranslationErrorTestCase, ...] = (
    DbtSourceFreshnessTranslationErrorTestCase(
...
@pytest.mark.parametrize(
    ...
    ids=[case.description for case in TRANSLATION_TEST_CASES],
)
...
@pytest.mark.parametrize(
    ...
    ids=["freshness null leaves source without SQLBuild freshness config"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["multiple manifest sources translate in stable unique id order"],
)
...
@pytest.mark.parametrize(
    "test_case",
    INVALID_DURATION_TEST_CASES,
    ids=[case.description for case in INVALID_DURATION_TEST_CASES],
)

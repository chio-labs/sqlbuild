...
SELECTION_TEST_CASES: list[DbtSelectionTestCase] = [
    ...
    DbtSelectionTestCase(
        ...
        expected_dbt_anchor_unique_ids_by_term={"state:modified+": ("model.analytics.int_orders",)},
    ),
    DbtSelectionTestCase(
        ...
        expected_dbt_anchor_unique_ids_by_term={"package:stripe+": ("model.analytics.int_orders",)},
    ),
    DbtSelectionTestCase(
        ...
        exclude=(),
        dbt_anchor_unique_ids_by_term={"source:stripe.charges+": ("model.analytics.int_orders",)},
        expected_sqlbuild_model_names=("fact_orders", "mart_orders"),
        expected_dbt_required_unique_ids=(),
    ...
    DbtSelectionTestCase(
        description="selects SQLBuild path translation directly",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
    ...
    DbtSelectionTestCase(
        description="selects SQLBuild Windows-style path translation directly",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
    ...
    DbtSelectionTestCase(
        description="selects SQLBuild path translation with upstream expansion",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
    ...
    DbtSelectionTestCase(
        description="selects SQLBuild path translation with downstream expansion",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
    ...
    DbtSelectionTestCase(
        description="selects SQLBuild native path directly",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,

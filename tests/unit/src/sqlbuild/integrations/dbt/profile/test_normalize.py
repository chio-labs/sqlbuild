...
NORMALIZE_TEST_CASES: tuple[DbtProfileNormalizeTestCase, ...] = (
    DbtProfileNormalizeTestCase(
...
NORMALIZE_ERROR_TEST_CASES: tuple[DbtProfileNormalizeErrorTestCase, ...] = (
    DbtProfileNormalizeErrorTestCase(
...
@pytest.mark.parametrize(
    ...
    ids=[case.description for case in NORMALIZE_TEST_CASES],
)
...
@pytest.mark.parametrize(
    "test_case",
    NORMALIZE_ERROR_TEST_CASES,
    ids=[case.description for case in NORMALIZE_ERROR_TEST_CASES],
)

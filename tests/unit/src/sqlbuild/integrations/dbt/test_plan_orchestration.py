...
PLAN_ORCHESTRATION_TEST_CASES: list[DbtPlanOrchestrationTestCase] = [
    ...
    DbtPlanOrchestrationTestCase(
        description="maps default dbt test to SQLBuild test and audit",
        command="test",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        ...
        expected_supplemental_dbt_command_argvs=(),
        expected_sqlbuild_command_argvs=(
            ("sqb", "test", "--select", "local_only"),
            ("sqb", "audit", "--select", "local_only"),
        ),
        expected_dbt_skipped=True,
        expected_sqlbuild_skipped=False,
        dbt_command_args=("--select", "local_only"),
        expected_primary_dbt_command_argv=("dbt", "test", "--select", "local_only"),
    ),
    DbtPlanOrchestrationTestCase(
        description="skips dbt test for SQLBuild-only selector with dbt upstreams",
        command="test",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        ...
        expected_sqlbuild_command_argvs=(
            ...
            ("sqb", "audit", "--select", "fact_orders"),
        ),
        expected_dbt_skipped=True,
        expected_sqlbuild_skipped=False,
        dbt_command_args=("--select", "fact_orders"),
        expected_primary_dbt_command_argv=("dbt", "test", "--select", "fact_orders"),
    ),
    DbtPlanOrchestrationTestCase(
        description="maps dbt data tests to SQLBuild audit only",
        command="test",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
        select=("test_type:data", "local_only"),
        exclude=(),
        full_dbt_ls_unique_ids=("test.analytics.not_null_stg_orders_order_id",),
        anchor_dbt_ls_unique_ids_by_term={},
        expected_dbt_ls_selects=(("test_type:data", "local_only"),),
        expected_sqlbuild_model_names=("local_only",),
        expected_dbt_required_unique_ids=(),
        expected_dbt_required_selector_terms=(),
        expected_supplemental_dbt_command_argvs=(),
        expected_sqlbuild_command_argvs=(("sqb", "audit", "--select", "local_only"),),
        expected_dbt_skipped=False,
        expected_sqlbuild_skipped=False,
        dbt_command_args=("--select", "test_type:data", "local_only"),
        expected_primary_dbt_command_argv=(
            "dbt",
            "test",
            "--select",
    ...
    DbtPlanOrchestrationTestCase(
        description="maps dbt unit tests to SQLBuild test only",
        command="test",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        sqlbuild_model_path_by_name=_SQLBUILD_PATHS,
        select=("test_type:unit", "local_only"),
        exclude=(),
        full_dbt_ls_unique_ids=("unit_test.analytics.orders_unit",),
        anchor_dbt_ls_unique_ids_by_term={},
        expected_dbt_ls_selects=(("test_type:unit", "local_only"),),
        expected_sqlbuild_model_names=("local_only",),
        expected_dbt_required_unique_ids=(),
        expected_dbt_required_selector_terms=(),
        expected_supplemental_dbt_command_argvs=(),
        expected_sqlbuild_command_argvs=(("sqb", "test", "--select", "local_only"),),
        expected_dbt_skipped=False,
        expected_sqlbuild_skipped=False,
        dbt_command_args=("--select", "test_type:unit", "local_only"),
        expected_primary_dbt_command_argv=(
            "dbt",
            "test",
            "--select",
    ...
    DbtPlanOrchestrationTestCase(
        description="keeps dbt indirect selection dbt-owned for SQLBuild planning",
        command="test",
        manifest_data=_MANIFEST_DATA,
        sqlbuild_model_sql_by_name=_SQLBUILD_SQL,
        sqlbuild_model_tags_by_name=_SQLBUILD_TAGS,
        ...
        expected_dbt_skipped=True,
        expected_sqlbuild_skipped=False,
        dbt_command_args=("--select", "local_only", "--indirect-selection", "eager"),
        expected_primary_dbt_command_argv=(
            "dbt",
            "test",
            "--select",

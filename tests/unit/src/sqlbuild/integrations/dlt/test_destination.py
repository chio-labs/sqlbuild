...
DESTINATION_TEST_CASES: list[DltDestinationTestCase] = [
    DltDestinationTestCase(
    ...
    DltDestinationTestCase(
        ...
        connection_config={"host": "localhost", "dbname": "db", "user": "user", "password": "pass"},
        dataset_name="raw",
    ...
    DltDestinationTestCase(
        ...
        connection_config={"host": "localhost", "database": "db", "user": "sa", "password": "pass"},
        dataset_name="raw",
...
@pytest.mark.parametrize(
    "test_case",
    DESTINATION_TEST_CASES,
    ids=[case.description for case in DESTINATION_TEST_CASES],
)
...
@pytest.mark.parametrize(
    ...
    ids=["covers all builtin adapters"],
)

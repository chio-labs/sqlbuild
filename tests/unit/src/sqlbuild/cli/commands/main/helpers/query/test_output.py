...
from tests.unit.src.sqlbuild.cli.commands.main.helpers.query._test_types import (
    QueryOutputTestCase,
)

QUERY_OUTPUT_TEST_CASES: list[QueryOutputTestCase] = [
    QueryOutputTestCase(
...
@pytest.mark.parametrize(
    "test_case",
    QUERY_OUTPUT_TEST_CASES,
    ids=[case.description for case in QUERY_OUTPUT_TEST_CASES],
)

    ...
    [
        DbtCloneCommandOutputTestCase(
            ...
            expected_stdout_fragments=(
                ...
                "1/1  cloned",
                "ANALYTICS.STAGING.COMMERCE__STG_ORDER -> ANALYTICS.DEV.COMMERCE__STG_ORDER  OK  0.92s",
    ...
    def run_dbt_clone_from_project(
        *,
        ...
        item: CloneItemResult = CloneItemResult(
            name="commerce__stg_order",
            action=CloneAction.CLONED,
            status=CloneStatus.SUCCESS,
            origin_relation="ANALYTICS.STAGING.COMMERCE__STG_ORDER",
            destination_relation="ANALYTICS.DEV.COMMERCE__STG_ORDER",

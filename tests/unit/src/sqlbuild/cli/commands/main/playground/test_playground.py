...
@pytest.mark.parametrize(
    ...
    ids=["creates clean waffle shop playground from packaged template"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["prints next steps after creating playground"],
)
def test_given_playground_command_when_running_then_it_prints_next_steps(
    ...
    exit_code: int = run_playground(tmp_path, test_case.target_path)

    ...
    (
        CompileTextOutputTestCase(
            ...
            expected_fragments=(
                ...
                "\u2713 Project compiled  3 models, 0 seeds, 0 functions, 0 errors, 0 warnings",
            ),
        ),
        CompileTextOutputTestCase(
            ...
            expected_fragments=(
                ...
                "\u2713 Project compiled  101 models, 0 seeds, 0 functions, 0 errors, 0 warnings",
            ),
...
@pytest.mark.parametrize(
    ...
    [
        CompileTextColorTestCase(
            ...
            expected_fragments=(
                "\033[34m\033[1mCompile ready\033[0m  \033[2m3 models\033[0m",
                "short",
                "\033[32mOK\033[0m",
                "\033[2m0 columns\033[0m",
                "\033[32m\u2713\033[0m Project compiled",
                "\033[2mWrote:\033[0m",
            ),
        ),
    ],

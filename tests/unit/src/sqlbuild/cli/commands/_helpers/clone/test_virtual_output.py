...
from sqlbuild.cli.commands._helpers.clone.virtual_output import render_virtual_clone_output
from tests.unit.src.sqlbuild.cli.commands._helpers.clone._test_types import (
    RenderVirtualCloneOutputTestCase,
)
from tests.unit.src.sqlbuild.cli.commands._helpers.clone.helpers import (
    ...
    (
        RenderVirtualCloneOutputTestCase(
            ...
            expected_color_fragments=(
                "\033[34m\033[1mVirtual clone\033[0m",
                "prod -> dev",
                "selected artifacts   \033[34m43\033[0m",

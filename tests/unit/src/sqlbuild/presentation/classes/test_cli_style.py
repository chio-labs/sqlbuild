...
from tests.unit.src.sqlbuild.presentation.classes._test_types import CliStyleTestCase
...
@pytest.mark.parametrize(
    ...
    [
        ...
        CliStyleTestCase(
            ...
            use_color=True,
            expected_title="\033[34m\033[1mTitle\033[0m",
            expected_section="\033[1mSection\033[0m",
            expected_label="\033[2mLabel\033[0m",
            expected_value="\033[34mValue\033[0m",
            expected_accent="\033[34mAccent\033[0m",
            expected_plan_section="\033[1mPlan section\033[0m",
            ...
            expected_error="\033[38;5;167mError\033[0m",
            expected_error_strong="\033[38;5;167m\033[1mError strong\033[0m",
            expected_error_muted="\033[38;5;167m\033[2merror\033[0m",
            expected_log_label="\033[2mlog\033[0m",
            expected_status_ok="\033[32mOK\033[0m",
            expected_status_error="\033[38;5;167mERROR\033[0m",
            expected_status_skip="\033[2mSKIP\033[0m",
            expected_dbt_section="\033[1mdbt\033[0m",
            expected_dbt_object_name="analytics.orders",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        CliStyleTestCase(
            ...
            expected_status_error="\033[38;5;167m[ERROR failed]\033[0m",

...
from tests.unit.src.sqlbuild.presentation.main._test_types import SummaryFooterTestCase
    ...
    (
        SummaryFooterTestCase(
            ...
            expected_color_fragments=(
                ...
                "\033[2mFAIL=\033[0m\033[38;5;167m0\033[0m",
        ...
        SummaryFooterTestCase(
            ...
            expected_color_fragments=(
                ...
                "\033[2mSYNC_FAIL=\033[0m\033[38;5;167m0\033[0m",
            ),
        ),
    ),

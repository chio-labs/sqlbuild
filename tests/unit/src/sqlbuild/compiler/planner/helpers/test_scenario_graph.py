...
PLAN_TEST_CASES: list[PlanScenarioGraphTestCase] = [
    PlanScenarioGraphTestCase(
    ...
    PlanScenarioGraphTestCase(
        description="seed fixture is required for seed dependency",
...
ERROR_TEST_CASES: list[PlanScenarioGraphErrorTestCase] = [
    PlanScenarioGraphErrorTestCase(
    ...
    PlanScenarioGraphErrorTestCase(
        description="missing seed fixture fails clearly",
        model_deps={"daily_revenue": ("country_codes",)},
        source_names=(),
        seed_names=("country_codes",),
        expected_model_names=("daily_revenue",),
        expected_error_fragment="requires seed 'country_codes'",
    ),
    PlanScenarioGraphErrorTestCase(

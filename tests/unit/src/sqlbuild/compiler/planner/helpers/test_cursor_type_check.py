...
RETURNS_WARNING_TEST_CASES: list[CursorTypeCheckTestCase] = [
    CursorTypeCheckTestCase(
...
@pytest.mark.parametrize(
    "test_case",
    RETURNS_WARNING_TEST_CASES,
    ids=[case.description for case in RETURNS_WARNING_TEST_CASES],
)
...
RETURNS_NONE_TEST_CASES: list[CursorTypeCheckTestCase] = [
    CursorTypeCheckTestCase(
...
@pytest.mark.parametrize(
    "test_case",
    RETURNS_NONE_TEST_CASES,
    ids=[case.description for case in RETURNS_NONE_TEST_CASES],
)

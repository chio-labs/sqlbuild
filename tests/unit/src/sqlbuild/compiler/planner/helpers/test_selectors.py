...
@pytest.mark.parametrize(
    ...
    [
        ...
        ParseSelectorTestCase(
            ...
            raw="staging/+",
            expected_result=ParsedSelector(
                kind=SelectorKind.PATH, value="staging", downstream=True
            ),
        ),
    ],
    ...
    [
        ...
        ResolveSelectorTestCase(
            ...
            expected_names=frozenset(
                {"joined", "orders", "customers", "raw_orders", "raw_customers"}
            ),
        ),
        ResolveSelectorTestCase(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ResolveSelectorTestCase(
            ...
            expected_names=frozenset(
                {"fact_orders", "int_enriched", "raw_orders", "raw_customers"}
            ),
        ),
        ResolveSelectorTestCase(
...
def test_given_model_paths_when_building_path_index_then_returns_expected_folders(
    ...
    from sqlbuild.compiler.helpers.selector_indexes import build_model_path_index

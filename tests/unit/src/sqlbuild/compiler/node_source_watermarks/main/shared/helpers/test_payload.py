...
from tests.unit.src.sqlbuild.compiler.node_source_watermarks.main.shared.helpers._test_types import (  # noqa: E501
...
@pytest.mark.parametrize(
    ...
    [
        WatermarkPayloadRoundTripTestCase(
            ...
            expected_source_name="partner_feed.events",
...
def test_given_watermark_payload_when_encoded_and_decoded_then_preserves_structured_entries(
    ...
    payload: NodeSourceWatermarkPayload = NodeSourceWatermarkPayload(
        ...
        unknown_sources=(
            UnknownSourceWatermarkEntry(
                source_name="partner_feed.late_feed",
                target_database=None,
                target_schema="main",
                target_name="dev",

...
from tests.integration.src.sqlbuild.cli.commands._helpers.diff._test_types import (
    DiffOutputIntegrationTestCase,
)
from tests.integration.src.sqlbuild.cli.commands._helpers.diff.helpers import (
                    ...
                    unequal_row_samples=(
                        build_sample_row(
                            ...
                            changed_cells=(
                                build_sample_cell(name="amount", left_value=10, right_value=12),
                                build_sample_cell(
                                    name="status", left_value="old", right_value="new"
                                ),
                            ),
                        ),
                    ),
                ...
                build_model_result(
                    ...
                    unequal_row_samples=(
                        ...
                        build_sample_row(
                            ...
                            changed_cells=(
                                build_sample_cell(
                                    name="status", left_value="old", right_value="done"
                                ),
                            ),
                        ),
                    ),

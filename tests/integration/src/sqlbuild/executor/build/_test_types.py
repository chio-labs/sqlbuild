...
class BuildExecutionTestCase:
    ...
    expected_function_error_codes: tuple[tuple[str, str], ...] = field(default_factory=tuple)
    ...
    expected_test_error_codes: tuple[tuple[str, str], ...] = field(default_factory=tuple)

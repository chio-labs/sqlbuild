...
@pytest.mark.parametrize(
    ...
    [
        FreshnessE2ETestCase(
            description="direct state comparison fails on timestamp movement beyond lag tolerance",
            expected_fragments=(
                "Changed (1)",
    ...
    ids=["direct state comparison fails on timestamp movement beyond lag tolerance"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["direct state comparison fails on backwards timestamp movement"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["direct state comparison reads state from multiple target schemas"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["direct state comparison reports unchanged source freshness"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["direct state comparison fails on changed source freshness"],
)
...
@pytest.mark.parametrize(
    ...
    [
        FreshnessE2ETestCase(
            description="direct state comparison tolerates timestamp movement within lag tolerance",
            expected_fragments=(
                "Tolerated (1)",
    ...
    ids=["direct state comparison tolerates timestamp movement within lag tolerance"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["direct state comparison fails when previous state is missing"],
)

...
@pytest.mark.parametrize(
    ...
    (
        DenseCompileGuardTestCase(
            ...
            14.0,
            3 * _GIB // 2,
            "1a9ce1bec2ca35aaffc3fdfa1d5fe321147637dc6eec5e1ef6db6da488078a49",
        ),
        DenseCompileGuardTestCase(
            ...
            34.0,
            11 * _GIB // 4,
            "515aac7c00acbef6433424e08da5334636c3e6b7c8cc18261c47b2679a7a1cc3",
        ),
        DenseCompileGuardTestCase(
            ...
            55.0,
            13 * _GIB // 4,
            "54ad7088d741dbd4de172d11181ba3f64426c5ce626e8825f8863f5799eb3234",
        ),
        DenseCompileGuardTestCase(
            ...
            145.0,
            4 * _GIB,
            "2e91d9f29e8f5f3981b4ba077d2c61f84833069811f4966b41637868fa6f19e8",
        ),
    ),

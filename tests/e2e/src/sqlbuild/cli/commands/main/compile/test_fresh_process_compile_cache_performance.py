...
@pytest.mark.parametrize(
    ...
    [
        FreshProcessCompileCachePerformanceGuardTestCase(
            ...
            test_count=2_945,
            audit_count=5_056,
            expected_cold_max_wall_seconds=12.5,
            expected_warm_max_wall_seconds=6.5,
            expected_edit_max_wall_seconds=6.0,
        ...
        FreshProcessCompileCachePerformanceGuardTestCase(
            ...
            test_count=9_816,
            audit_count=16_855,
            expected_cold_max_wall_seconds=37.5,
            expected_warm_max_wall_seconds=20.0,

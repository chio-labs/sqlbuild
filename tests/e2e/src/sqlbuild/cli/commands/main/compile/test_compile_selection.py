...
@pytest.mark.parametrize(
    ...
    [
        CompileSelectionTestCase(
            ...
            selection_args=("--select", "racecard", "result"),
        ...
        CompileSelectionTestCase(
            ...
            unexpected_stdout_fragments=("racecard", "unrelated", "error[K001]"),
        ),
    ],
...
def test_given_model_selection_when_compiling_then_limits_offline_analysis_and_report(
    ...
    project_dir: Path = prepare_inline_project(
        ...
        repo_files={
            ...
            "models/racecard.sql": "MODEL ();\n\nSELECT 1 AS race_id\n",
            "models/result.sql": (
                'MODEL (columns (race_id ()));\n\nSELECT race_id FROM __ref("racecard")\n'
            ),

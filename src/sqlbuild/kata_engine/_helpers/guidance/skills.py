...
def _rule_example(*, rule: KataRule) -> str:
    examples: dict[str, str] = {
        ...
        "SQBKR503": "order_status and order_status_history consolidate under order_status.",
        ...
        "SQBKH305": "Group normalise_order.py and normalise_person.py under normalise/.",

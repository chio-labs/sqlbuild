"""Model migration state table SQL entrypoint."""
...
def build_migration_state_create_table_sql(
    *,
    database: str | None,
    schema: str,
    ...
    """Build DDL that creates the model migration event table when it is missing."""

...
from sqlbuild.cli.commands._helpers.scenario_capture.dialect import (
    require_scenario_capture_dialect,
)
...
from sqlbuild.integrations.dbt.main.pipeline.scenario import build_dbt_scenario_project

        ...
        try:
            _ = finalize_build_cost(
                BuildCostFinalization(
                    ...
                    target_database=compiled_project.effective_target_database,
    ...
    *,
    ...
    cost_record: CostRunRecord | None = finalize_build_cost(
        BuildCostFinalization(
            ...
            target_database=result.project.effective_target_database,
            run_id=result.project.run_id,
    ...
    *,
    ...
    _ = finalize_build_cost(
        BuildCostFinalization(
            ...
            target_database=project.effective_target_database,

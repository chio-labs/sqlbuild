"""Public policy type-layer declarations."""
...
class RuleContext(Protocol):
    """Public model analysis capabilities available to policy rules."""
...
class PolicyCheck(Protocol):
    """One policy rule implementation."""

    def __call__(self, *, model: CompiledModel, ctx: RuleContext) -> list[PolicyFault]: ...

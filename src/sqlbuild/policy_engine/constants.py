...
CANONICAL_ONE: str = "1"
POLICY_DECORATOR_TOKEN: str = "@policy"
POLICY_DIRECTORY_NAME: str = "policy"
PARENT_DIRECTORY_TOKEN: str = ".."
TRACKED_POLICY_FILE_SUFFIXES: frozenset[str] = frozenset({".py", ".sql", ".toml", ".yaml", ".yml"})
...
CUSTOM_RULE_COVERAGE_CODE: str = "SQBPT301"
POLICY_THRESHOLD_RULE_CODES: frozenset[str] = frozenset({"SQBPT201", "SQBPT202"})
POLICY_LAYOUT_RULE_PREFIXES: tuple[str, str] = ("SQBPR2", "SQBPD3")
POLICY_LAYOUT_THRESHOLD_RULE_CODES: frozenset[str] = frozenset(
    {"SQBPR203", "SQBPR204", "SQBPD303", "SQBPD304", "SQBPD306"}
)
...
POLICY_THRESHOLD_DEFAULTS: dict[str, int] = {

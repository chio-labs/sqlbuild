...
from sqlbuild.policy_engine.constants import MAX_ENTITY_PARTS, MODEL_NAME_PART_COUNT
from sqlbuild.policy_engine.models import ModelNameParts
...
def parse_model_name(name: str) -> ModelNameParts | None:
    """Parse the closed policy model-name grammar."""

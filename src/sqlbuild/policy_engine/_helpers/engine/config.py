"""Native-owned strict policy configuration loading."""
...
from sqlbuild.policy_engine._helpers.engine.native import load_native_config
...
def _cache(value: object) -> PolicyCacheConfig:

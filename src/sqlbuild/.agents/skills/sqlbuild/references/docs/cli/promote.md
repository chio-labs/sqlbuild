...
Online: https://docs.sqlbuild.com/cli/promote
...
See [Promotion](../concepts/virtual-environments/promotion.md) for details on promotion behavior, source requirements, and guards.

...
Online: https://sqlbuild.com/docs/cli/janitor/
...
When `retention_days` is not set, it defaults to `14`. See [Project Configuration](../concepts/project-configuration.md#janitor) for every janitor setting.

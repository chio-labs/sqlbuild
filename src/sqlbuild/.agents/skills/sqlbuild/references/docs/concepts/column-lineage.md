...
See the [lineage CLI reference](../cli/lineage.md) for full flag documentation and output format examples.
...
See the [compile CLI reference](../cli/compile.md) for details on the compile report format.

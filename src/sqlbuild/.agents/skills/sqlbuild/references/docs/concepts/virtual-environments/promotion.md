...
Online: https://docs.sqlbuild.com/concepts/virtual-environments/promotion
...
Use `sqb diff` to compare VDE ref sets before promoting. See [Diff](diff.md) for details.

...
|-------|------------|-----|
| [`inline_sql("...")`](hooks/sql.md#inline-sql-hooks) | SQL written directly in the model header | Short, model-specific SQL |
| [`sql("name", args...)`](hooks/sql.md) | A reusable resource under `hooks/sql/` | Shared, parameterized SQL |
| [`python("name", args...)`](hooks/python.md) | A decorated function under `hooks/python/` | Control flow, providers, queries, or skips |
...
- [SQL hooks](hooks/sql.md)
- [Python hooks](hooks/python.md)

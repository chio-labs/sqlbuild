...
Online: https://docs.sqlbuild.com/concepts/virtual-environments/adopt-detach
...
Detached VDE refs and state rows are cleaned up by the [janitor](janitor.md), not by detach itself. This preserves refs for recovery if detach fails partway through.

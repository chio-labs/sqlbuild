...
Online: https://docs.sqlbuild.com/concepts/virtual-environments/clone
...
Clone is a physical-layer operation. VDE pointer management is handled by [build](building.md) and [promote](promotion.md).

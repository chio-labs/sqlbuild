...
from sqlbuild.rule_engine.constants import MAX_ENTITY_PARTS, MODEL_NAME_PART_COUNT
from sqlbuild.rule_engine.models import ModelNameParts
...
def parse_model_name(name: str) -> ModelNameParts | None:
    """Parse the closed rule model-name grammar."""

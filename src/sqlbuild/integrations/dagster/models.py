"""Dagster integration runtime models."""
...
class SqlBuildProject:
    ...
    def prepare(self) -> None:
        """Generate the SQLBuild DAG artifact by invoking ``sqb dag --json``."""
        ...
        try:
            ...
            raise DagsterProjectPrepareError(
    ...
    def prepare_if_dev(self) -> None:
        """Generate the DAG artifact when running under Dagster local development."""

...
from sqlbuild.integrations.dbt.main.selection._adapt_project_for_scenarios import (
    adapt_project_for_dbt_scenarios,
)
from sqlbuild.integrations.dbt.main.selection._resolve_scenario_target_names import (

...
from sqlbuild.presentation.constants import (
    ERROR_STATUS_LABELS,
    SKIPPED_STATUS_LABELS,
    SUCCESS_STATUS_LABELS,
    WARNING_STATUS_LABELS,
)
from sqlbuild.presentation.models import CliTheme, TextStyle
...
default_cli_theme: CliTheme = CliTheme(
    ...
    accent_strong=TextStyle(_BLUE + _BOLD),
...
class CliStyle:
    ...
    def accent_strong(self, text: str) -> str:
        return self.theme.accent_strong.apply(text=text, use_color=self.use_color)
